...
public class BundleEditor
{
    ...
    private static string ABCONFIGPATH = "Assets/Editor/Resource/ABConfig.asset";
    ...
    public static void EncryptBuild()
    {
        Build(true);
    }

    public static void Build(bool isEncrypt = false)
    {
        m_ConfigFil.Clear();
        m_AllFileAB.Clear();
        m_AllFileDir.Clear();
    ...
    static void BunildAssetBundle(bool isEncrypt = false)
    {
